...
#
#   sys.path.insert(0, '/mnt/c/Users/seanm/OneDrive/Documents/Research/documentation/SpatialPy')
sys.path.append('..')


# -- Project information -----------------------------------------------------

# The following reads the variables without doing an "import spatialpy",
...
spatialpy = {}
with open(path.join(ROOT_DIR, 'spatialpy/__version__.py')) as f:
    text = f.read().rstrip().splitlines()
    vars = [line for line in text if line.startswith('__') and '=' in line]
    for v in vars:
        setting = v.split('=')
        spatialpy[setting[0].strip()] = setting[1].strip().replace("'", '')


project   = spatialpy['__title__']
copyright = spatialpy['__copyright__']
author    = spatialpy['__author__']

# The short X.Y version
version   = spatialpy['__version__']
version   = version[:version.rfind('.')]

# The full version, including alpha/beta/rc tags
release   = spatialpy['__version__']
...
htmlhelp_basename = 'SpatialPydoc'
...
html_theme_options = {
    ...
    'fixed_sidebar': 'true',
    'github_banner': 'true',
    'logo': 'SpatialPy_logo.png',
    'touch_icon': 'SpatialPy_logo.svg',
...
html_css_files = [
    'css/spatialpy_alabaster_customizations.css',
]
...
# -- Additional stuff for SpatialPy 
