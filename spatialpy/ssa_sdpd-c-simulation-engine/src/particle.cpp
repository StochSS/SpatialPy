...
namespace Spatialpy{
	...
	for(n = x_index->prev; n!=NULL; n=n->prev){
...
void add_particle(particle_t* me, system_t* system){
    ...
    x_index = linked_list_add(system->x_index, me);
    //y_index = linked_list_add(system->y_index, me);
    //z_index = linked_list_add(system->z_index, me);
    neighbors = create_neighbor_list();
