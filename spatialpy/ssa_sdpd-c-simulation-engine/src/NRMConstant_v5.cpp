...
void NRMConstant_v5::printHashTable() {
    ...
    void NRMConstant_v5::build(std::vector<double>& propensities, generatorType& generator,
               double propensitySum, std::size_t activeChannels,
               double timeOffset, double simulationEndTime) {
...
NRMConstant_v5::~NRMConstant_v5() {
    ...
    template <class generatorType>
    void NRMConstant_v5::build(std::vector<Spatialpy::Particle> particles, generatorType& generator, double propensitySum, std::size_t activeChannels, double timeOffset, double simulationEndTime) {
        //        std::cout << "in build..." << std::endl;
        activeChannelCounter=activeChannels;
        endTime=simulationEndTime;
        previousFiringTime=timeOffset;//initialize (could set to nan or something instead)
    ...
    template <class generatorType>
    void NRMConstant_v5::update(std::size_t reactionIndex, double newPropensity, double currentTime, generatorType& generator) {
